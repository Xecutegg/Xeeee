...
export default {
    ...
    async execute(client, message) {
        ...
        if (message.content === `<@${client.user.id}>`) {
            ...
            let embed = new EmbedBuilder().setColor(Colors.Blue).setFooter({ text: `Made By Xecute ❤️`, iconURL: message.author.displayAvatarURL({ dynamic: true }) }).setDescription(
            ...
            ).addFields({ name: `__Links__`, value: `[Support](https://discord.gg/WVThZG7Q5X) | [Invite](https://discord.gg/WVThZG7Q5X)` }).setAuthor({ name: `Hey I am ${client.user.username}`, iconURL: client.user.displayAvatarURL({ dynamic: true }) }).setThumbnail(message.author.displayAvatarURL({ dynamic: true }))
